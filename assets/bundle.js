...
var highlight = _dereq_('./src'); // const highlight = require('./builds/compromise-highlight')
...
highlight(editor, patterns); //run highlighting on init
...
var highlight = function highlight(editor, patterns) {
  ...
  editor.on('change', function (doc) {
    // get text
    var str = doc.getValue(); // parse it

    var d = nlp(str); // run each pattern
