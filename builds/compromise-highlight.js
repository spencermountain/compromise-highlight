(function (global, factory) {
  ...
  var _02FailFast = failFast; // i formally apologize for how complicated this is.
  ...
  */
  ...
  var Pool_1 = Pool; //(Rule-based sentence boundary segmentation) - chop given text into its proper sentences.
  ...
  var _03Contractions = contractions; //mostly pos-corections here
  ...
  var fixMisc = miscCorrection; //Determiner-signals
  ...
  var fixDates_1 = fixDates; // verb: 100.828ms
  // dates: 80.874ms
  // person: 66.054ms
  // nouns: 51.340ms
  // adj: 19.760ms
  ...
  var nlp$1 = getCjsExportFromNamespace(compromise);
...
//# sourceMappingURL=compromise-highlight.js.map
